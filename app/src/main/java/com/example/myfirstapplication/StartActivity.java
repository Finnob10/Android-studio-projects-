...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.buttonUIEvent), (v, insets) -> {
        ...
        Button buttonUILocation = findViewById(R.id.buttonUILocation);
        buttonUILocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button buttonSQL = findViewById(R.id.buttonSQL);
